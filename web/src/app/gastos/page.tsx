...
import { getGastosMes, searchGastos, getCategorias, getAllComercios, contarArchivosPorGastos, getRecurrentes } from '@/lib/queries'
...
export default async function GastosPage({
  ...
  const [gastos, categorias, comercios, recurrentes] = await Promise.all([
  ...
  const archivoCounts = await contarArchivosPorGastos(gastoIds)
